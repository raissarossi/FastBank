...
const ToggleTheme = () => {
  ...
  return (
    <div>
      <SunIcon className='w-7 h-7 text-gray-100 cursor-pointer hidden dark:block m-3' onClick={toggleTheme} />
      <MoonIcon className='w-6 h-6 text-gray-100 cursor-pointer block dark:hidden m-3' onClick={toggleTheme} />
    </div>
  )
}
